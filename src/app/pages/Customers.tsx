...
import { Users as UsersIcon, Clock, Sparkles } from 'lucide-react';
            ...
            >
              ...
              <div className="relative inline-block">
                ...
                <div className="relative p-6 rounded-full bg-gradient-to-br from-[#0F4C81]/10 to-[#0F4C81]/5">
                  <UsersIcon className="w-16 h-16 text-[#0F4C81]" />
                </div>
              ...
              {/* Title */}
              <div>
                <h2 className="text-[#0F4C81] mb-2">Customer Management</h2>
              ...
              <div className="space-y-4">
                <p className="text-muted-foreground text-lg leading-relaxed">
                  We're building an amazing customer management experience for you. Track customer interactions, purchase history, and build lasting relationships with your valued customers.
                </p>
                
                {/* Features Preview */}
                <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
                  <div className="p-4 rounded-xl bg-[#0F4C81]/5 border border-[#0F4C81]/10">
                    <h4 className="text-[#0F4C81] mb-2">Customer Profiles</h4>
                    <p className="text-sm text-muted-foreground">
                      Detailed profiles with contact info and purchase history
                    </p>
                  </div>
                  <div className="p-4 rounded-xl bg-[#0F4C81]/5 border border-[#0F4C81]/10">
                    <h4 className="text-[#0F4C81] mb-2">Purchase Analytics</h4>
                    <p className="text-sm text-muted-foreground">
                      Track spending patterns and customer lifetime value
                    </p>
                  </div>
                  <div className="p-4 rounded-xl bg-[#0F4C81]/5 border border-[#0F4C81]/10">
                    <h4 className="text-[#0F4C81] mb-2">Loyalty Programs</h4>
                    <p className="text-sm text-muted-foreground">
                      Reward your best customers with points and discounts
                    </p>
                  </div>
                  <div className="p-4 rounded-xl bg-[#0F4C81]/5 border border-[#0F4C81]/10">
                    <h4 className="text-[#0F4C81] mb-2">Communication</h4>
                    <p className="text-sm text-muted-foreground">
                      Send targeted messages and promotional offers
                    </p>
                  </div>
                </div>
              </div>
