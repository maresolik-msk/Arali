import svgPaths from "./svg-7oxij0di9j";
  ...
  return (
    <div className="absolute inset-[0.52%_0]" data-name="Group">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24.0003 23.7508">
        <g id="Group">
          <path clipRule="evenodd" d={svgPaths.pd610340} fill="var(--fill-0, #546F86)" fillRule="evenodd" id="Vector" />
          <path clipRule="evenodd" d={svgPaths.p14ff900} fill="var(--fill-0, #546F86)" fillRule="evenodd" id="Vector_2" />
          <path clipRule="evenodd" d={svgPaths.p222f1a80} fill="var(--fill-0, #546F86)" fillRule="evenodd" id="Vector_3" />
        </g>
      </svg>
    </div>
  );
...
function StreamlineFreehandEditPenWritePaper() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 overflow-clip size-[24px] top-1/2" data-name="streamline-freehand:edit-pen-write-paper">
      <Group1 />
    </div>
  );
}
